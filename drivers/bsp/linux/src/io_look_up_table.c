...
ahw_io_map uart_expander_max14830_obc; ///< UART expander max 14830 OBC
...
void ahw_io_lookup_table_updt(void)
{
    ...
    imu_bmx160_obc_1.ahw_id = IMU_BMX160_OBC_1;
    imu_bmx160_obc_1.ahw_type = IMU;
    imu_bmx160_obc_1.io_instance_id = IOAL_INST_I2C4;
    imu_bmx160_obc_1.slv_addr = (0x68<<1);

    imu_bmx160_obc_2.ahw_id = IMU_BMX160_OBC_2;
    imu_bmx160_obc_2.ahw_type = IMU;
    imu_bmx160_obc_2.io_instance_id = IOAL_INST_I2C4;
    imu_bmx160_obc_2.slv_addr = (0x69<<1);
    ...
    digital_thermostat_ds620_spe01.ahw_type = DIGI_THERM;
    ...
    digital_thermostat_ds620_spe02.ahw_type = DIGI_THERM;
    ...
    digital_thermostat_ds620_spb01.ahw_type = DIGI_THERM;
    ...
    digital_thermostat_ds620_spw01.ahw_type = DIGI_THERM;
    ...
    digital_thermostat_ds620_spw02.ahw_type = DIGI_THERM;
