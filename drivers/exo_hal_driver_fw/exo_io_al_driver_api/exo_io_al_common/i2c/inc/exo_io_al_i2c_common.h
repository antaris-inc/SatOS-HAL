...
typedef struct _ioal_i2c_hdle
{
    ...
    void (*mst_tx_cplt_cb)(struct _ioal_i2c_hdle *hi2c); 	/*!< Hold Fn address for I2C Master Tx Transfer completed callback ID */
    void (*mst_rx_cplt_cb)(struct _ioal_i2c_hdle *hi2c); 	/*!< Hold Fn address for I2C Master Rx Transfer completed callback ID */
    void (*abort_cplt_cb)(struct _ioal_i2c_hdle *hi2c); 	/*!< Hold Fn address for Abort complete event */
    void (*listen_cplt_cb)(struct _ioal_i2c_hdle *hi2c); 	/*!< Hold Fn address for Listen complete event */
    void (*error_cb)(struct _ioal_i2c_hdle *hi2c);			/*!< Hold Fn address for error event */
}ioal_i2c_hdle;
