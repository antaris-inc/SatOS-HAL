...
//volatile uint16_t eth_rx_pkt = 0;
//volatile uint16_t eth_tx_pkt = 0;
//volatile uint16_t eth_tx_fail = 0;
...
#define ETH_RX_BUFFER_CNT           25     /* This app buffers receive packets of its primary service
...
static void low_level_init(struct netif *netif)
{
  ...
  attributes.priority = P_ETHERNET;
  ...
  { 
    ...
    */
	  ...
	  memset(&attributes, 0x0, sizeof(osThreadAttr_t));
	  attributes.name = "RMII_Watchdog";
	  attributes.stack_size = configMINIMAL_STACK_SIZE;
	  attributes.priority = osPriorityRealtime;

	  osThreadNew(RMII_Thread, NULL, &attributes);
...
#if 0
        uint32_t eth_data[12] = {0};
        LAN8742_Read_PhyReg(&LAN8742, LAN8742_BSR,&eth_data[0]);
        LAN8742_Read_PhyReg(&LAN8742, LAN8742_BCR,&eth_data[1]);
        LAN8742_Read_PhyReg(&LAN8742, LAN8742_PHYI1R, &eth_data[2]);
        LAN8742_Read_PhyReg(&LAN8742, LAN8742_PHYI2R, &eth_data[3]);
        LAN8742_Read_PhyReg(&LAN8742, LAN8742_ANAR,   &eth_data[4]);
        LAN8742_Read_PhyReg(&LAN8742, LAN8742_ANLPAR, &eth_data[5]);
        LAN8742_Read_PhyReg(&LAN8742, LAN8742_ANER, &eth_data[6]);
        LAN8742_Read_PhyReg(&LAN8742, LAN8742_MCSR, &eth_data[7]);
        LAN8742_Read_PhyReg(&LAN8742, LAN8742_SCSIR, &eth_data[8]);
        LAN8742_Read_PhyReg(&LAN8742, LAN8742_SMR, &eth_data[9]);
        LAN8742_Read_PhyReg(&LAN8742, LAN8742_PHYSCSR, &eth_data[10]);
#endif
      }
    }
