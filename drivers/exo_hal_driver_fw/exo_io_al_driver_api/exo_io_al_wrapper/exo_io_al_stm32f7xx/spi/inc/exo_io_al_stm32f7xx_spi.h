...
/**
 * @brief This function initialize the control block memory and do basic configurations of SPI1
 * @param[in] ioal_spi1 - ioal_spi1 pointer to a ioal_spi_hdle structure that
 *                  contains the configuration information for SPI1
 * @retval HAL status
 */
hal_ret_sts io_hal_stm32f7xx_spi1_init(ioal_spi_hdle *ioal_spi1);
/**
 * @brief This function initialize the control block memory and do basic configurations of SPI2
 * @param[in] ioal_spi2 - ioal_spi1 pointer to a ioal_spi_hdle structure that
 *                  contains the configuration information for SPI2
 * @retval HAL status
 */
hal_ret_sts io_hal_stm32f7xx_spi2_init(ioal_spi_hdle *ioal_spi2);
/**
...
/**
 * @brief This function register SPI1 callback event
...
/**
 * @brief This function register SPI2 callback event
 * @retval No return
 */
...
#define io_hal_common_spi2_init                 io_hal_stm32f7xx_spi2_init
