 ...
 */
typedef void (*ahal_gpio_exp_cb_fptr_t)(void* args);
...
typedef struct
{
    ...
    uint8_t mode;       /*!< gpio pin mode                  */
    uint8_t pull_sts;       /*!< gpio pin pull enable status            */
    ahal_gpio_exp_cb_fptr_t cb_func;  /*!< gpio pin call back function pointer      */
    void* cb_func_args;
}ahw_al_gpio_exp_gpio_cfg;
...
/**
 * @brief This API read and write data from register
 * @param[in] ahw_id           : application hardware instance ID
 * @return Result of API execution status
 * @retval zero -> Success / -ve value -> Error.
 */
 ...
 * @param[in] ahw_id           : application hardware instance ID
 * @param[in] pin_cfg          : GPIO pin configuration structure pointer
 * @return Result of API execution status
 * @retval zero -> Success / -ve value -> Error.
 */
 ...
 * @retval zero -> Success / -ve value -> Error.
 */
hal_ret_sts ahw_al_gpio_exp_set_pol_inv(uint32_t ahw_id, gpio_exp_gpio_pin pin, gpio_exp_pin_pol polarity);
 ...
 * @retval zero -> Success / -ve value -> Error.
 */
hal_ret_sts ahw_al_gpio_exp_set_input_lat(uint32_t ahw_id, gpio_exp_gpio_pin pin, gpio_exp_pin_lat latch);
 ...
 * @retval zero -> Success / -ve value -> Error.
 */
hal_ret_sts ahw_al_gpio_exp_set_intr_msk(uint32_t ahw_id, gpio_exp_gpio_pin pin, gpio_exp_mask flag);
 ...
 * @retval zero -> Success / -ve value -> Error.
 */
hal_ret_sts ahw_al_gpio_exp_set_port_cfg(uint32_t ahw_id, gpio_exp_gpio_pin pin, gpio_exp_port_cfg flag);
