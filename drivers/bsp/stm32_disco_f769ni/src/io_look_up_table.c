...
ahw_io_map psm_ina230_obc;
ahw_io_map psm_ina230_ps;
ahw_io_map psm_ina230_ps_2;
ahw_io_map gpio_expander_pcal6408a_ps;
ahw_io_map gpio_expander_mcp23008_edge_1;
ahw_io_map gpio_expander_mcp23008_edge_2;
ahw_io_map gpio_expander_mcp23008_gps;
ahw_io_map digital_thermostat_ds620_ps;
ahw_io_map digital_thermostat_ds620_edge;
ahw_io_map hsc_adm1176_edge;
ahw_io_map hsc_adm1176_ps_1;
ahw_io_map hsc_adm1176_ps_2;
ahw_io_map thruster_morpheus_obc;
ahw_io_map voltage_sequencer_ucd9801_obc;
ahw_io_map data_logger_ads7828_ps;
ahw_io_map digital_thermostat_ds620_spe01;
ahw_io_map digital_thermostat_ds620_spe02;
ahw_io_map digital_thermostat_ds620_spw01;
ahw_io_map digital_thermostat_ds620_spw02;
ahw_io_map digital_thermostat_ds620_spb01;
ahw_io_map ext_mem_mx25l512_qspi;
ahw_io_map ext_mem_mt25ql512_qspi;
ahw_io_map uart_expander_max14830_obc;
...
void ahw_io_lookup_table_updt(void)
{
    ...
    uart_expander_max14830_obc.io_instance_id=IOAL_INST_SPI2;
        //spi_to_uart_conv.slv_addr = 0x00;
